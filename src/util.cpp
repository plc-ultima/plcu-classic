...
const char * const BITCOIN_CONF_FILENAME = "plcultimac.conf";
const char * const BITCOIN_PID_FILENAME = "plcultimac.pid";
...
#else
    const char* pszModule = "plcultimac";
#endif
    if (pex)
        return strprintf(
