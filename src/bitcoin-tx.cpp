...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s plcultimac-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  plcultimac-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded plcultimac transaction") + "\n" +
              "  plcultimac-tx [options] -create [commands]   " + _("Create hex-encoded plcultimac transaction") + "\n" +
              "\n";
