...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/plcultimac-project/plcultimac>";
    const std::string URL_WEBSITE = "<https://plcultimac.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("PLC Ultima Classic version %s\n", FormatFullVersion());
}
