...
BITCOIND=${BITCOIND:-$SRCDIR/plcultimacd}
BITCOINCLI=${BITCOINCLI:-$SRCDIR/plcultimac-cli}
BITCOINTX=${BITCOINTX:-$SRCDIR/plcultimac-tx}
BITCOINQT=${BITCOINQT:-$SRCDIR/qt/plcultimac-qt}
