...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 PLCUC from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 PLCUC with subtract fee from amount
        ...
        # Sendmany 10 PLCUC with subtract fee from amount
