...
class AbandonConflictTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        inputs =[]
        # spend 10 PLCUC outputs from txA and txB
        ...
        # Identify the 14.998 PLCUC output
        ...
        # Verify that B and C's 10 PLCUC outputs are available for spending again because AB1 is now conflicted
        newbalance = self.nodes[0].getbalance()
        assert_equal(newbalance, balance + amount10 * 2)
        balance = newbalance

        # There is currently a minor bug around this and so this test doesn't work.  See Issue #7315
        # Invalidate the block with the double spend and B's 10 PLCUC output should no longer be available
