...
def SignatureHash(script, txTo, inIdx, hashtype, txtmp=None):
    ...
    if txtmp is None:
        ...
        assert_equal(hashtype, SIGHASH_ALL)  # txtmp as a parameter is implemented only for SIGHASH_ALL (to optimize performance)
    ...
    # Return txtmp to its original state (only for SIGHASH_ALL):
    txtmp.vin[inIdx].scriptSig = b''
