...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Node0's balance should be starting balance, plus 50 PLCUC for another
        ...
        # Check node0's total balance; should be same as before the clone, + miner_reward * 2 PLCUC for 2 matured,
